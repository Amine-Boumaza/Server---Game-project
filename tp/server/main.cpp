 ...
 ****************************************************************************************/
 void init_bib(){    /*  initialisation  --- � ne pas changer */
    WSADATA WSAData;
 ...
 *---------------------------------------------------*/
 int creation_et_configuration_socket_eccoute(SOCKET * socketEcoute){
    ...
    if( creation_reussite == 0 ) return 0 ;   /* probl�me de cr�ation de socket d'�coute */
 ...
 ****************************************************************************************/
 ...
 void fermeture_de_socket_Ecoute(SOCKET socktEcoute){ // � ne pas changer
...
/*-*************************************************************************************/
 ...
 void fermeture_de_socket_dialog(SOCKET sockDialogue){  // � ne pas changer
 ...
 ****************************************************************************************/
 ...
 int recevoir_message_de_client(SOCKET sockDialogue, char * buffer ) {
    ...
    if( nbr_octets_lus > 0 ) {     /* r�ception coorecte de n octets */
...
/*-**************************************************************************************/
 ...
 int initialisation_du_jeu(){
    ...
    if( etat_de_connexion == 0 ) return 0 ;   /* quiter l'ex�cution car il y a un probl�me de connexion */
    ...
    if( etat_envoi == 0 )  return 0 ;   /* quitter l'ex�cution car il y a une erreur lors de l'envoi du message */
...
int main(){
    ...
    if( creation_reussite == 0 ) return 0 ;   /* quiter l'ex�cution car il y a un probl�me de cr�ation de socket d'�coute */
